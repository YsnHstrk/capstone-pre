...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Yasin12345',
        'HOST': 'database-v2.cm6sdmw70sor.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'capstone-deneme-ysn' # please enter your s3 bucket name
